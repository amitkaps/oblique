...
- **oblique-symmetric.ttf (this repo's own, built 2026-09-18)** — slnt range -11 to 11 (used as the test font for tests/oblique-style-matching/auto-derived-range-clamp-cairo-symmetric.html — matches Cairo's own symmetric range exactly, not just the excludes-default-angle shape; source: verified via fontTools fvar read, 2026-09-19)
